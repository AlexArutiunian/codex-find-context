...
Тесты покрывают parser rollout-подобного JSONL, незавершённую последнюю строку активного writer, rename persistence, нативный rename RPC payload, incremental reindex, semantic ranking и навигацию по истории.
