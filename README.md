...
- умеет искать как по **всем чатам**, так и **только внутри одного конкретного чата**, чтобы находить нужный участок длинной сессии;
...
Во вкладке «Поиск по смыслу» есть поле **«Где искать»**:

- `🌐 Все чаты` — старый глобальный поиск;
- любой конкретный чат — semantic ranking идёт только по chunks этой сессии;
- кнопка **«Текущий чат»** мгновенно выбирает чат, который сейчас открыт во вкладке «Чаты».

Это удобно для запросов вида «где именно в этом длинном чате я менял threshold» или «найди участок, где мы решили перейти с одного подхода на другой». При scoped search даже FTS fallback тоже ограничивается выбранной сессией.
...
Тесты покрывают parser rollout-подобного JSONL, незавершённую последнюю строку активного writer, rename persistence, нативный rename RPC payload, incremental reindex, semantic ranking, scoped semantic/FTS search и навигацию по истории.
